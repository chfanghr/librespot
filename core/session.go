...
import (
	...
	"github.com/chfanghr/librespot/connection"
	"github.com/chfanghr/librespot/crypto"
	"github.com/chfanghr/librespot/discovery"
	"github.com/chfanghr/librespot/mercury"
	"github.com/chfanghr/librespot/player"
...
func (s *Session) startConnection() error {
	...
	if err != nil {
		log.Fatal("Error receiving packet for hello: ", err)
		return err
	}
